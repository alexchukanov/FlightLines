#pragma checksum "C:\UWPprojects\FlightLines\App15\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "C07432E540F82DE847C5FCA23D62C8F2"
//------------------------------------------------------------------------------
// <auto-generated>
            ...
            IMainPage_Bindings
        {
                    ...
                    case 5: // MainPage.xaml line 35
                        ...
                        (this.obj5).LostFocus += (global::System.Object sender, global::Windows.UI.Xaml.RoutedEventArgs e) =>
                        {
                            if (this.initialized)
                            {
                                ...
                                this.dataRoot.ViewModel.LinesNum = this.obj5.Text;
                            }
                        };
                        break;
            ...
            private void Update_ViewModel(global::App15.LinesViewModel obj, int phase)
            {
                ...
                if (obj != null)
                {
                    ...
                    if ((phase & (NOT_PHASED | DATA_CHANGED | (1 << 0))) != 0)
                    {
                        this.Update_ViewModel_LinesNum(obj.LinesNum, phase);
                    }
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
            ...
            private void Update_ViewModel_LoadLinesCommand(global::App15.RelayCommand obj, int phase)
            {
            ...
            private void Update_ViewModel_LinesNum(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
                    ...
                    if (bindings != null)
                    {
                        ...
                        if (global::System.String.IsNullOrEmpty(propName))
                        {
                            if (obj != null)
                            {
                                ...
                                bindings.Update_ViewModel_LinesNum(obj.LinesNum, DATA_CHANGED);
